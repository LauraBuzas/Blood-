...
<<<<<<< HEAD
    private static rootEmployees: string = 'http://localhost:65063/employees';
    private static rootRegisterEmployees: string = 'http://localhost:65063/account/register/employee';
=======

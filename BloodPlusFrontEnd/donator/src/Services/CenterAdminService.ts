...
export class CenterAdminService {
    ...
    private static rootEmployees: string = 'http://localhost:49853/employees';
    private static rootRegisterEmployees: string = 'http://localhost:59851/account/register/employee';
